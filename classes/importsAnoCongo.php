		...
		for($i=1; $i <= $objPHPExcel->getSheetCount()-1;$i++){
			...
			if($objPHPExcel->setActiveSheetIndex($i)){
				...
				{	
					...
					$params['attributes']['zones_actions'] 				= $Zones_actions;
					$params['attributes']['adhesion_reseaux'] 			= $Adhesion_reseaux;
					$params['attributes']['partenaires_financiers'] 	= $Partenaires_financiers;
					$params['attributes']['autres_financiers']			= $Autres_Partenaires;
					$params['attributes']['principales_activites'] 		= $Principales_activites;
					$params['attributes']['points_forts_organisation'] 	= $Points_forts_organisation;
					$params['attributes']['points_faibles_organisation']= $Points_faibles_organisation;
					$params['attributes']['besoins'] 					= $Besoins;
